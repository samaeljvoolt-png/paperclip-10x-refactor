  ...
  const supervisorWorkflow =
    agentKind === "supervisor"
      ? [
          ...
          "- If the issue body or constraints say 'Single-owner execution' or 'Ejecución de owner único', do not delegate or create child issues. Complete the deliverable directly and register evidence yourself.",
